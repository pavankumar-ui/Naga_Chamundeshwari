...
const Home = () => {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-dark max-w-3xl mx-auto">
              ...
              Chamundeshwari Temple, a sacred place of worship for generations.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              <h3 className="text-2xl font-cinzel font-semibold text-maroon mb-4">
                Our Divine History
              </h3>
              <p className="text-dark mb-4">
                Sri Naga Chamundeshwari Temple, located in Puttenahalli Village,
                stands as a symbol of faith, tradition, and community service.
                The temple's history is deeply connected with the respected
                family of Sri Thimmarayappa, whose ancestors have lived in
                Puttenahalli for nearly ten to twelve generations.
              </p>
              <p className="text-dark mb-6">
                The family of Sri Mariyappa and Sri Thimmarayappa played a
                significant role in the social and cultural life of the village.
              </p>
              <Link href="/about">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <Card className="bg-light shadow-md">
              <CardContent className="p-8">
                ...
                <p className="text-dark">
                  The temple is believed to fulfill wishes of devotees who
                  worship here with pure devotion and faith. It is known for its
            ...
            <Card className="bg-light shadow-md">
              <CardContent className="p-8">
                ...
                <p className="text-dark">
                  The temple showcases exquisite stone carvings, intricate
                  pillars, and traditional sanctum design following ancient
                  Vastu principles.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-light shadow-md">
              <CardContent className="p-8">
                ...
                <p className="text-dark">
                  Devotees visit seeking blessings for prosperity, health,
                  marriage, children, and removal of obstacles in their life
                  journey.
                </p>
              </CardContent>
            </Card>
      ...
      {/* Featured Events */}
      <FeaturedEvents events={events?.slice(0, 3)} isLoading={eventsLoading} />
      ...
      <section className="py-16 bg-cream">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <div className="section-divider"></div>
            <p className="text-dark max-w-3xl mx-auto">
              Glimpses of our temple architecture, festivals, and divine
              moments.
            </p>
          </div>
      ...
      >
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-cinzel font-bold mb-3 drop-shadow-lg">
              Support Our Temple
            </h2>
            <div className="w-24 h-1 bg-gold mx-auto mb-6"></div>
            <p className="mb-8 drop-shadow-md text-lg">
              Your generous donations help us maintain the temple, conduct
              regular rituals, organize festivals, and support charitable
              activities. Join us in preserving our sacred traditions.
            </p>
